...
<head>
    ...
    <!-- Title -->
    <title>{{ setting('name') }} @if (trim($__env->yieldContent('title')))
            | @yield('title')
        @endif
    </title>
    ...
    @else
        ...
        <link href="{{ asset('panel/assets/css-rtl/colors/default.css" rel="stylesheet') }}">
...
.language-switcher a {
    ...
    color: #000; /* لون النص الذي ترغب في استخدامه */
    font-weight: bold;
        ...
        <div class="main-sidebar main-sidebar-sticky side-menu">
            <div class="sidemenu-logo">
                <a class="main-logo" href="{{ url('/') }}">
                    <img src="{{ url(setting('logo')) }}" class="header-brand-img desktop-logo" alt="logo"
                        style="max-height: 52px">
                    <img src="{{ url(setting('logo')) }}" class="header-brand-img icon-logo" alt="logo"
                        style="max-height: 52px">
                    <img src="{{ url(setting('logo')) }}" class="header-brand-img desktop-logo theme-logo"
                        alt="logo" style="max-height: 52px">
                    <img src="{{ url(setting('logo')) }}" class="header-brand-img icon-logo theme-logo" alt="logo"
                        style="max-height: 52px">
                </a>
            </div>
            <div class="main-sidebar-body">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('home') }}"><span class="shape1"></span><span
                                class="shape2"></span><i class="ti-home sidemenu-icon"></i><span
                                class="sidemenu-label">{{ trans('web_trans.dashboard') }}</span></a>
                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('admins.index') }}">{{ trans('web_trans.admin_list') }}</a>
                                </li>
                                <li class="nav-sub-item">
                    ...
                    @if ((Auth::user()->isAdmin() && Auth::user()->can('Category')) || Auth::user()->isSuperAdmin())
                        <li class="nav-item">
                            ...
                            <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" href="{{ route('categories.index') }}">{{ trans('web_trans.Category_list') }}</a>
                                </li>
                            </ul>
                        </li>
                    @endif
                    ...
                    @if ((Auth::user()->isAdmin() && Auth::user()->can('Setting')) || Auth::user()->isSuperAdmin())
                                ...
                                @foreach ($setting_groups as $group)
                                    <li class="nav-sub-item">
                                        <a class="nav-sub-link"
                                            href="{{ route('settings.show', $group->name) }}">{{ $group->name }}</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link with-sub" href="#0">
                                ...
                                <span class="sidemenu-label">{{trans('web_trans.menu')}}</span>
                                <i class="angle fe fe-chevron-right"></i>
                            </a>
                            <ul class="nav-sub">
                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" 
                                        href="{{route('index.menu')}}">{{trans('web_trans.menu')}}</a>
                                </li>

                                <li class="nav-sub-item">
                                    <a class="nav-sub-link" 
                                        href="{{route('index.drag.menu')}}">{{trans('web_trans.drag_menu')}}</a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="container-fluid">
                ...
                <div class="main-header-center">
                    <div class="responsive-logo">
                        <a href="index.html"><img src="{{ url('panel/assets/img/brand/logo.png') }}"
                                class="mobile-logo" alt="logo"></a>
                        <a href="index.html"><img src="{{ url('panel/assets/img/brand/logo-light.png') }}"
                    ...
                    <div class="dropdown main-profile-menu">
                        <a class="d-flex" href="#">
                            <span class="main-img-user"><img alt="avatar"
                                    src="{{ url(auth()->user()->profile()) }}"></span>
                        </a>
                        <div class="dropdown-menu">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                    <div class="d-flex order-lg-2 ml-auto">
                                ...
                                <div class="main-notification-list">
                                    <div class="media new">
                                        <div class="main-img-user online"><img alt="avatar"
                                                src="{{ url('panel/assets/img/users/5.jpg') }}"></div>
                                    ...
                                    <div class="media">
                                        <div class="main-img-user"><img alt="avatar"
                                                src="{{ url('panel/assets/img/users/2.jpg') }}"></div>
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <div class="main-img-user online"><img alt="avatar"
                                                src="{{ url('panel/assets/img/users/3.jpg') }}"></div>
                                        <div class="media-body">
                        ...
                        <div class="dropdown main-profile-menu">
                            <a class="d-flex" href="#">
                                <span class="main-img-user"><img alt="avatar"
                                        src="{{ url('panel/assets/img/users/1.jpg') }}"></span>
                            </a>
                            <div class="dropdown-menu">
                                <div class="header-navheading">
                                    <h6 class="main-notification-title">{{ auth()->user()->name }}</h6>
